...
resource "oci_core_virtual_network" "hortonworks_vcn" {
...
resource "oci_core_internet_gateway" "hortonworks_internet_gateway" {
    ...
    vcn_id = "${oci_core_virtual_network.hortonworks_vcn.id}"
}
...
resource "oci_core_subnet" "public" {
  ...
  dhcp_options_id = "${oci_core_virtual_network.hortonworks_vcn.default_dhcp_options_id}"
